package com.christopoulos.moviesearch.presentation.ui.splash
...
*  - appIconResId: Resource ID of the app icon to display (default is R.drawable.moviesearch)
...
fun SplashScreen(
    ...
    appIconResId: Int = R.drawable.moviesearchapp
) {
    LaunchedEffect(Unit) {
        delay(delayMillis)
        onTimeout()
